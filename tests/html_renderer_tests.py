...
class TestFragmentize(TestCase):
    ...
    def test_spans_are_ordered(self):
        ...
        self.assertEqual(fragments[0].spans, (span_1, span_2, span_3))
        self.assertEqual(fragments[1].spans, (span_1, span_2))
        ...
        self.assertEqual(fragments[1].spans, (span_3, span_2))
        self.assertEqual(fragments[2].spans, (span_3, span_2, span_1))
        self.assertEqual(fragments[3].spans, tuple())
